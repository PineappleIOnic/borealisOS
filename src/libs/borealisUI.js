...
module.exports = class BorealisUI {
  ...
  generateScript () {
    const clientScript = 'window.__BOREALISUI__ = JSON.parse(`' + JSON.stringify(this.generatedCode) + '`);'
    const serverScript = 'module.exports = JSON.parse(`' + JSON.stringify(this.generatedCode) + '`);'
